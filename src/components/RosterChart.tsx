  ...
  return (
    <section id="roster" className="roster">
      ...
      <p className="section-lede">
        A call starts, an email lands, or a target account enters the list. The
        right agent opens the tools it needs and keeps working. Drafts stay
        drafts until the seller approves them.
      </p>
